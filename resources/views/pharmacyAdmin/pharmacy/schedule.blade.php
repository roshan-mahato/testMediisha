@extends('layout.mainlayout_admin',['activePage' => 'pharmacy_schedule'])

@section('title',__('Schedule'))
@section('content')
<section class="section">
    @include('layout.breadcrumb',[
        'title' => __('pharmacy schedule'),
    ])
...
<div class="modal fade" id="edit_time_slot" tabindex="-1" role="dialog" aria-labelledby="edit_time_slot" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <form action="" method="post" class="working_pharmacy_form">
                @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <label class="cursor-pointer">
                                    <input type="checkbox" name="status" id="status_1" class="custom-switch-input">
