...
<title>Doctro - Installer</title>
    ...
    <link rel="stylesheet" href="{{ asset('assets_admin/css/fontawesome.css') }}" integrity="sha384-fnmOCqbTlWIlj8LyTjo7mOUStjsKC4pOpQbqyi7RrhN7udi9RwhKkMHpvLbHG9Sr" crossorigin="anonymous">
                        ...
                        <?php
                            ...
                            <form action="#" id="admin-detal-form" method="POST">
                                <div class="field">
                                    ...
                                    <div class="control">
                                        <input class="input" type="email" value="admindoctro@gmail.com" id="email" placeholder="Enter your admin email" name="email">
