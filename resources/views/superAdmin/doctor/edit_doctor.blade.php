                ...
                <div class="row mt-4">
                    <div class="col-lg-6 form-group">
                        ...
                        <div class="d-flex">
                            ...
                            <input type="number" min="1" readonly value="{{$doctor->user['phone']}}" name="phone" class="form-control @error('phone') is-invalid @enderror">
                        </div>
                        @error('phone')
                        <div class="invalid-feedback">
                            {{ $message }}
            ...
            <div class="card-body">
                <div class="row mt-4">
                    <div class="col-lg-6 form-group">
                        ...
                        <input type="number" min="1" name="experience" value="{{ $doctor->experience }}" class="form-control @error('experience') is-invalid @enderror">
                        @error('number')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                    ...
                    <div class="col-lg-6 form-group">
                        ...
                        <input type="number" min="1" name="appointment_fees" value="{{ $doctor->appointment_fees }}" class="form-control @error('appointment_fees') is-invalid @enderror">
                ...
                <div class="row mt-4">
                    <div class="col-lg-6  form-group custom_timeslot {{ $doctor->timeslot != 'other' ? 'hide' : '' }}">
                        ...
                        <input type="text" name="custom_timeslot" value="{{ $doctor->custom_timeslot }}" class="form-control custom_timeslot_text @error('custom_timeslot') is-invalid @enderror">
                    ...
                    <div class="col-lg-6 form-group base_on_com {{ $doctor->based_on != 'commission' ? 'hide' : '' }}">
                        ...
                        <input type="text" name="commission_amount" {{ $doctor->based_on == 'commission_amount' ? 'required' : '' }} value="{{ $doctor->commission_amount }}" class="form-control base_on_com_text @error('commission_amount') is-invalid @enderror">
